import imagenContacto from "../../assets/home/image_1.webp"
    ...
    <div className="container mx-auto">
      <div className="py-12 flex justify-center rounded-xl border border-white bg-white shadow-md shadow-black/5 saturate-200">
        <div className="my-8 grid gap-6 px-4 w-1/3 max-lg:hidden">
          <div className="flex items-center gap-4 w-5/6 font-light">
            ...
            <div>
              <p className="block antialiased text-base leading-relaxed text-inherit">Terrerito #1326, La Puerta, Tepatitlán de Morelos</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <p className="block antialiased text-base leading-relaxed text-inherit">378 782 5552</p>
          </div>
          <div className="flex items-center gap-4">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#fdb913" aria-hidden="true" className="h-6 w-6">
            ...
            <p className="block antialiased text-base leading-relaxed text-inherit">direcciongeneral@batepa.mx</p>
          </div>
        </div>
