  ...
  return (
    <section class="bg-white dark:bg-gray-900">
      <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <p class="mb-8 lg:mb-16 text-center text-gray-500  text-xl">¿Quieres saber más acerca de nosotros o tienes alguna pregunta? Dejanoslo saber</p>
          <form action="#" class="space-y-8">
              <div>
                  <label for="email" class="block mb-2 text-xl font-medium text-gray-900 dark:text-gray-300">Tu correo</label>
              ...
              <div>
                  <label for="subject" class="block mb-2 text-xl font-medium text-gray-900 dark:text-gray-300">Asunto</label>
              ...
              <div class="sm:col-span-2">
                  <label for="message" class="block mb-2 text-xl font-medium text-gray-900 dark:text-gray-400">Tu mensaje</label>
