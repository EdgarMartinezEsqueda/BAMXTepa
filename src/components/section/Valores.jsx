          ...
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16" >
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 text-center">
              <div className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring" href="/" >
                ...
                <p className="mt-2 font-normal">Apoyo al prójimo</p>
              </div>
              <div className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring" href="/" >
                <span className="inline-block rounded-full bg-gray-50 p-3 text-rojoLogo">
                  < FavoriteIcon />
                </span>
                <p className="mt-2 font-normal">Gratitud</p>
              </div>
              <div className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring" href="/" >
                <span className="inline-block rounded-full bg-gray-50 p-3 text-rojoLogo">
                  < TaskAltIcon />
                </span>
                <p className="mt-2 font-normal"> Honestidad</p>
              </div>
              <div className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring" href="/" >
                <span className="inline-block rounded-full bg-gray-50 p-3 text-rojoLogo">
                  < Diversity2Icon />
                </span>
                <p className="mt-2 font-normal"> Solidaridad</p>
              </div>
              <div className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring" href="/" >
                <span className="inline-block rounded-full bg-gray-50 p-3 text-rojoLogo">
                  <BackHandIcon/>
                </span>
                <p className="mt-2 font-normal"> Voluntad </p>
              </div>
              <div className="block rounded-xl border border-gray-100 p-4 shadow-sm hover:border-gray-200 hover:ring-1 hover:ring-gray-200 focus:outline-none focus:ring" href="/" >
                <span className="inline-block rounded-full bg-gray-50 p-3 text-rojoLogo">
                  <VolunteerActivismIcon />
                </span>
                <p className="mt-2 font-normal">Compromiso</p>
              </div>
            </div>
          </div>
        </div>
